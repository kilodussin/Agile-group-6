  ...
  /**
    ...
    */
    private void createPages() {
        ...
        page1.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.1.png", 500, 350, false));
        ...
        // Page 2
         ...
         imagePanel.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.2.png", 280, 205, false));
         imagePanel.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.3.png", 280, 205, false));
         imagePanel.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.4.png", 280, 205, false));
        ...
        page3.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.5.png", 500, 350, false));
        innerCenterPanel.add(page3, "Page 3");


        // Page 4
        List<ImageDescriptionPair> page4Content = new ArrayList<>();
        page4Content.add(new ImageDescriptionPair("Resources/Trashcan/Compost_RecBin.png", "What can be thrown into the Compost bin?"));
        ...
        page5Content.add(new ImageDescriptionPair("Resources/Trashcan/Plastic_RecBin.png", "What can be thrown into the Plastic bin?"));
        ...
        page6Content.add(new ImageDescriptionPair("Resources/Trashcan/Combustible_RecBin.png", "What can be thrown into the Combustible bin?"));
        ...
        page7Content.add(new ImageDescriptionPair("Resources/Trashcan/Glass_RecBin.png", "What can be thrown into the glass bin?"));
        ...
        page8Content.add(new ImageDescriptionPair("Resources/Trashcan/NonRec_RecBin.png", "What can be thrown into the Non-recyclable bin?"));
        ...
        page9.add(TutorialComponents.createImagePanel("Resources/Tutorials/Gamemode1.6.jpg", 500, 350, false));
