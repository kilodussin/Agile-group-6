...
public class CombustibleTrash extends Trash{
    ...
    public ArrayList<ImageDescriptionPair> generateAvailableImages(){
        ...
        availableImages.add(factory.createImageDescriptionPair("It’s easy to think that envelopes can be sorted as newspaper or paper packages. In reality however, it’s actually categorized as flammable trash. If sorted together with newspaper/paper packaging, the glue on the envelopes can clog up the machines used during the recycling process, rendering them unable to function properly.","Resources/Trash/Envelope_Trash.png" ));
        availableImages.add(factory.createImageDescriptionPair("Most people think that glassware can be sorted and recycled together with glass. However, that’s not the case. Majority of glassware is actually crafted using materials that increase its durability. These materials would cause disturbance to the recycling process if mixed together with glass. That is why glassware should be sorted as flammable trash (Preferably well-packaged, in order to prevent any unnecessary accidents).", "Resources/Trash/Glasware_Trash.png" ));
        availableImages.add(factory.createImageDescriptionPair("Most people think that Barbie dolls cant be recycled. However they can be used for energy recycling and should therefore be sorted as combustible. ", "Resources/Trash/Barbie_Trash.png"));
        availableImages.add(factory.createImageDescriptionPair("Chewing gum could mistakenly be thrown in the food disposal, however it is often made from synthetic rubber and should therefore be thrown in the flammable trash.", "Resources/Trash/Chewing_Gum_Trash.png"));
        availableImages.add(factory.createImageDescriptionPair("An empty toilet paper roll is made of cardboard and should therefore be sorted in the combustible recycling bin to be burned for energy.", "Resources/Trash/Empty_Toilet_Roll_Trash.png"));
        availableImages.add(factory.createImageDescriptionPair("You might think books with a hard cover should be recycled as newspaper or paper but the hardcover attatched to the book can’t be recycled as either so it is thrown into brännbart?", "Resources/Trash/Paperback_Trash.png"));
        availableImages.add(factory.createImageDescriptionPair("Standard milk cartons are made of paper with a plastic liner, the cartons should be sorted as combustible since during the recycling process the paper is separated from the plastic by a machine called a hydro pulper.", "Resources/Trash/Milk_Trash.png"));
